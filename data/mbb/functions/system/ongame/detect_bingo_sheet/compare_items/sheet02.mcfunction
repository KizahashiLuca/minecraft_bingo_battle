...
execute store success score @p[tag=MBB_CompareSheet] MBB_SheetTmp2 run data modify entity @s Item.tag set from entity @p[tag=MBB_CompareSheet] EnderItems[{Slot:8b}].tag
...
execute as @p[tag=MBB_CompareSheet,scores={MBB_Sheet02=1}] run item replace entity @s enderchest.8 from entity @s enderchest.2
