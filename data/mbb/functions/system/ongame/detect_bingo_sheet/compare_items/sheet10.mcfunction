...
execute if predicate mbb:system/common/gamerule/individual_match run scoreboard players set @p[tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] MBB_Sheet10 1
execute if predicate mbb:system/common/gamerule/team_match run function mbb:system/ongame/detect_bingo_sheet/set_sheet/sheet10
