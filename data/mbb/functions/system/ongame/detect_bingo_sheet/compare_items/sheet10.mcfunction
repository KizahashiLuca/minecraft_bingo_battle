...
execute as @s[team=MBB_TeamA,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamA] MBB_Sheet10 1
execute as @s[team=MBB_TeamB,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamB] MBB_Sheet10 1
execute as @s[team=MBB_TeamC,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamC] MBB_Sheet10 1
execute as @s[team=MBB_TeamD,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamD] MBB_Sheet10 1
execute as @s[team=MBB_TeamE,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamE] MBB_Sheet10 1
execute as @s[team=MBB_TeamF,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamF] MBB_Sheet10 1
execute as @s[team=MBB_TeamG,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamG] MBB_Sheet10 1
execute as @s[team=MBB_TeamH,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamH] MBB_Sheet10 1
execute as @s[team=MBB_TeamI,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamI] MBB_Sheet10 1
execute as @s[team=MBB_TeamJ,tag=MBB_CompareSheet,scores={MBB_SheetTmp1=0,MBB_SheetTmp2=0}] run scoreboard players set @a[team=MBB_TeamJ] MBB_Sheet10 1
