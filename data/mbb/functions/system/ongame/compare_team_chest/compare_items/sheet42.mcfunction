...
## Set item data
execute at @e[predicate=mbb:system/common/world_spawn] positioned ~-1 -62 ~13 run data modify entity @s Item.id set from block ~-1 ~ ~ Items[{Slot:13b}].id
execute at @e[predicate=mbb:system/common/world_spawn] positioned ~-1 -62 ~13 run data modify entity @s Item.tag set from block ~-1 ~ ~ Items[{Slot:13b}].tag
...
scoreboard players set @e[predicate=mbb:system/ongame/compare_team_chest/compare_items/main,scores={MBB_SheetTmp4=1..},limit=1] MBB_Sheet42 1
scoreboard players set @a[predicate=mbb:system/common/team_leader/main,scores={MBB_SheetTmp4=1..}] MBB_Sheet42 1

## Copy item
execute if entity @e[predicate=mbb:system/ongame/compare_team_chest/compare_items/not_same] run data modify entity @s Item.Count set from block ~-1 ~ ~ Items[{Slot:13b}].Count
...
execute if entity @e[predicate=mbb:system/ongame/compare_team_chest/compare_items/same] run item modify block ~-1 ~ ~ container.13 mbb:system/ongame/detect_ender_chest/set_enchant
