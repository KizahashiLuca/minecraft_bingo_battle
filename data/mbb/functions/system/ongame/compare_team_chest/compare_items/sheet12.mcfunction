...
## Compare item data
### id
execute store success score @e[predicate=mbb:system/ongame/compare_team_chest/compare_items/main,limit=1] MBB_SheetTmp1 run data modify entity @s Item.id set from block ~ ~ ~ Items[{Slot:13b}].id
### tag
...
execute if predicate mbb:system/ongame/compare_team_chest/tagged_items/sheet12 run scoreboard players set @e[predicate=mbb:system/ongame/compare_team_chest/compare_items/main,limit=1] MBB_SheetTmp2 0
### item count
...
execute if predicate mbb:system/common/gamerule/team_match run function mbb:system/ongame/compare_team_chest/set_sheet_true/sheet12
