...
## Set world spawn
execute at @p[tag=MBB_Host] align xyz positioned ~0.5 ~0.0 ~0.5 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["MBB_WorldSpawn"],NoGravity:1b,Invulnerable:1b,Particle:"block air",Radius:0.5f,Duration:2147483647}
...
## Teleport
execute at @e[predicate=mbb:system/common/world_spawn] positioned ~ -62 ~ run tp @a ~ ~ ~

## Set count down
scoreboard players set #mbb MBB_Tick 0
scoreboard players set #mbb MBB_Second 30
