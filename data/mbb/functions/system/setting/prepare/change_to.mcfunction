...
tellraw @a ["",{"text":"  Area : ","color":"white","bold":false},{"score":{"name":"#mbb","objective":"MBB_GameArea"},"color":"green","bold":true},{"text":"x","color":"green","bold":true},{"score":{"name":"#mbb","objective":"MBB_GameArea"},"color":"green","bold":true}]
