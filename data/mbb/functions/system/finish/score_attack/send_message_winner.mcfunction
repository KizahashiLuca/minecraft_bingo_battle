...
execute if score #mbb MBB_GameGroup matches 1 run tellraw @a ["",{"text":"    ","color":"white","bold":false},{"score":{"name":"@s","objective":"MBB_NumBingo"},"color":"red","bold":true},{"text":" BINGO","color":"white","bold":false}]
execute if score #mbb MBB_GameGroup matches 2 run tellraw @a ["",{"text":"    ","color":"white","bold":false},{"score":{"name":"@s[tag=MBB_TeamLeader]","objective":"MBB_NumBingo"},"color":"red","bold":true},{"text":" BINGO","color":"white","bold":false}]
