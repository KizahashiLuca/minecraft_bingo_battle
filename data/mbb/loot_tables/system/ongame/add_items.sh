...
if [ `echo "${item}" | grep -e structure -e destroy -e attached -e potted -e empty_ -e fire_ -e command_ -e _still -e _flow -e debug -e _portal -e redstone_dust -e tipped_arrow_ -e roots_pot` ] || [ "${item}" = "water" ] || [ "${item}" = "magma" ] || [ "${item}" = "tripwire" ] || [ "${item}" = "potatoes" ] || [ "${item}" = "frosted_ice" ] || [ "${item}" = "cocoa" ] || [ "${item}" = "fire" ] || [ "${item}" = "spawn_egg" ] || [ "${item}" = "music_disc" ] || [ "${item}" = "soul_fire" ] || [ "${item}" = "cave_vines" ] || [ "${item}" = "dead" ] || [ "${item}" = "mushroom_block" ] || [ "${item}" = "powder_snow" ] || [ "${item}" = "broken_elytra" ] || [ "${item}" = "tall_seagrass" ] || [ "${item}" = "filled_map_markings" ] || [ "${item}" = "spyglass_model" ] || [ "${item}" = "jigsaw_lock" ] || [ "${item}" = "grass_block_snow" ] || [ "${item}" = "farmland_moist" ]; then
  continue;
